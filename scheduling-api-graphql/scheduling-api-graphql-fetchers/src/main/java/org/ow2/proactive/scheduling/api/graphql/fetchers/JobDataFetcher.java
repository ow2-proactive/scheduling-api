    ...
    protected Stream<Job> dataMapping(Stream<JobData> dataStream, DataFetchingEnvironment environment) {
        return dataStream.map(jobData -> {
            ...
            return Job.builder()
                      ...
                      .cumulatedCoreTime(jobData.getCumulatedCoreTime())
                      .parentId(jobData.getParentId())
                      .childrenCount(jobData.getChildrenCount())
                      .numberOfNodes(jobData.getNumberOfNodes())
                      .numberOfNodesInParallel(jobData.getNumberOfNodesInParallel())
