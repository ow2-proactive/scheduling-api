 ...
 */
@Data
public class ComparableChildrenCount extends ComparableIntegerInput {
    ...
    public final static TypeSingleton<GraphQLInputType> TYPE = new TypeSingleton<GraphQLInputType>() {
        ...
        public GraphQLInputType buildType(DataFetcher... dataFetchers) {
            return newInputObject().name(Types.COMPARABLE_CHILDREN_COUNT.getName())
                                   .description("Children count input.")
                                   .field(newInputObjectField().name(BEFORE.getName())
                                                               .description("Jobs having children count lower than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .field(newInputObjectField().name(AFTER.getName())
                                                               .description("Jobs having children count greater than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .build();
        }
    ...
    public ComparableChildrenCount(Map<String, Object> input) {
        super(input);
    }
