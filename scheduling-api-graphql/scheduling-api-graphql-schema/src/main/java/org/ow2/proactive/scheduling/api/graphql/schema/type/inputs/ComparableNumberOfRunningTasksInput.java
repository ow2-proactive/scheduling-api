 ...
 */
@Data
public class ComparableNumberOfRunningTasksInput extends ComparableIntegerInput {
    ...
    public final static TypeSingleton<GraphQLInputType> TYPE = new TypeSingleton<GraphQLInputType>() {
        ...
        public GraphQLInputType buildType(DataFetcher... dataFetchers) {
            return newInputObject().name(Types.COMPARABLE_NUMBER_OF_RUNNING_TASKS_INPUT.getName())
                                   .description("Number of running tasks input.")
                                   .field(newInputObjectField().name(BEFORE.getName())
                                                               .description("Jobs having a number of running tasks lower than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .field(newInputObjectField().name(AFTER.getName())
                                                               .description("Jobs having a number of running tasks greater than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .build();
        }
    ...
    public ComparableNumberOfRunningTasksInput(Map<String, Object> input) {
        super(input);
    }
