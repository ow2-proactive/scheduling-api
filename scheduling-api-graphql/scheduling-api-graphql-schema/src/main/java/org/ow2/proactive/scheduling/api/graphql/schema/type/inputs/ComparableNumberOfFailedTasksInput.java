 ...
 */
@Data
public class ComparableNumberOfFailedTasksInput extends ComparableIntegerInput {
    ...
    public final static TypeSingleton<GraphQLInputType> TYPE = new TypeSingleton<GraphQLInputType>() {
        ...
        public GraphQLInputType buildType(DataFetcher... dataFetchers) {
            return newInputObject().name(Types.COMPARABLE_NUMBER_OF_FAILED_TASKS_INPUT.getName())
                                   .description("Number of failed tasks input.")
                                   .field(newInputObjectField().name(BEFORE.getName())
                                                               .description("Jobs having a number of failed tasks lower than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .field(newInputObjectField().name(AFTER.getName())
                                                               .description("Jobs having a number of failed tasks greater than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .build();
        }
    ...
    public ComparableNumberOfFailedTasksInput(Map<String, Object> input) {
        super(input);
    }
