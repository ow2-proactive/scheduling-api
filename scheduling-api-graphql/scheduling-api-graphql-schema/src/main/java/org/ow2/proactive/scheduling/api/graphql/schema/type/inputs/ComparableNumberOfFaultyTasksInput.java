 ...
 */
@Data
public class ComparableNumberOfFaultyTasksInput extends ComparableIntegerInput {
    ...
    public final static TypeSingleton<GraphQLInputType> TYPE = new TypeSingleton<GraphQLInputType>() {
        ...
        public GraphQLInputType buildType(DataFetcher... dataFetchers) {
            return newInputObject().name(Types.COMPARABLE_NUMBER_OF_FAULTY_TASKS_INPUT.getName())
                                   .description("Number of faulty tasks input.")
                                   .field(newInputObjectField().name(BEFORE.getName())
                                                               .description("Jobs having a number of faulty tasks lower than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .field(newInputObjectField().name(AFTER.getName())
                                                               .description("Jobs having a number of faulty tasks greater than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .build();
        }
    ...
    public ComparableNumberOfFaultyTasksInput(Map<String, Object> input) {
        super(input);
    }
