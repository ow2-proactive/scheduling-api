 ...
 */
@Data
public class ComparableCumulatedCoreTime extends ComparableLongInput {
    ...
    public final static TypeSingleton<GraphQLInputType> TYPE = new TypeSingleton<GraphQLInputType>() {
        ...
        public GraphQLInputType buildType(DataFetcher... dataFetchers) {
            return newInputObject().name(Types.COMPARABLE_CUMULATED_CORE_TIME.getName())
                                   .description("Cumulated core time input.")
                                   .field(newInputObjectField().name(BEFORE.getName())
                                                               .description("Jobs having cumulated core time lower than this value.")
                                                               .type(GraphQLLong)
                                                               .build())
                                   .field(newInputObjectField().name(AFTER.getName())
                                                               .description("Jobs having cumulated core time greater than this value.")
                                                               .type(GraphQLLong)
                                                               .build())
                                   .build();
        }
    ...
    public ComparableCumulatedCoreTime(Map<String, Object> input) {
        super(input);
    }
