 ...
 */
@Data
public class ComparableNumberOfNodesInParallel extends ComparableIntegerInput {
        ...
        public GraphQLInputType buildType(DataFetcher... dataFetchers) {
            return newInputObject().name(Types.COMPARABLE_NUMBER_OF_NODES_IN_PARALLEL.getName())
                                   ...
                                   .field(newInputObjectField().name(AFTER.getName())
                                                               .description("Jobs having number of nodes in parallel greater than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .build();
        }
    ...
    public ComparableNumberOfNodesInParallel(Map<String, Object> input) {
        super(input);
    }
