 ...
 */
@Data
public class ComparableNumberOfInErrorTasksInput extends ComparableIntegerInput {
    ...
    public final static TypeSingleton<GraphQLInputType> TYPE = new TypeSingleton<GraphQLInputType>() {
        ...
        public GraphQLInputType buildType(DataFetcher... dataFetchers) {
            return newInputObject().name(Types.COMPARABLE_NUMBER_OF_IN_ERROR_TASKS_INPUT.getName())
                                   .description("Number of in-error tasks input.")
                                   .field(newInputObjectField().name(BEFORE.getName())
                                                               .description("Jobs having a number of in-error tasks lower than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .field(newInputObjectField().name(AFTER.getName())
                                                               .description("Jobs having a number of in-error tasks greater than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .build();
        }
    ...
    public ComparableNumberOfInErrorTasksInput(Map<String, Object> input) {
        super(input);
    }
