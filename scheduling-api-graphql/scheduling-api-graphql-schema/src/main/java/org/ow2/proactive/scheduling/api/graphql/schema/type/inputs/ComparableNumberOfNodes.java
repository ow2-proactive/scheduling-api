 ...
 */
@Data
public class ComparableNumberOfNodes extends ComparableIntegerInput {
    ...
    public final static TypeSingleton<GraphQLInputType> TYPE = new TypeSingleton<GraphQLInputType>() {
        ...
        public GraphQLInputType buildType(DataFetcher... dataFetchers) {
            return newInputObject().name(Types.COMPARABLE_NUMBER_OF_NODES.getName())
                                   .description("Number of nodes input.")
                                   .field(newInputObjectField().name(BEFORE.getName())
                                                               .description("Jobs having number of nodes lower than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .field(newInputObjectField().name(AFTER.getName())
                                                               .description("Jobs having number of nodes greater than this value.")
                                                               .type(GraphQLInt)
                                                               .build())
                                   .build();
        }
    ...
    public ComparableNumberOfNodes(Map<String, Object> input) {
        super(input);
    }
