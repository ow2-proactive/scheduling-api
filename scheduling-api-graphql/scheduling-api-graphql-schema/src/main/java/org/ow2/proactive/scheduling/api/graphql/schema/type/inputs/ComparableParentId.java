 ...
 */
@Data
public class ComparableParentId extends ComparableLongInput {
    ...
    public final static TypeSingleton<GraphQLInputType> TYPE = new TypeSingleton<GraphQLInputType>() {
        ...
        public GraphQLInputType buildType(DataFetcher... dataFetchers) {
            return newInputObject().name(Types.COMPARABLE_PARENT_ID.getName())
                                   .description("Parent id input.")
                                   .field(newInputObjectField().name(BEFORE.getName())
                                                               .description("Jobs having parent id lower than this value.")
                                                               .type(GraphQLLong)
                                                               .build())
    ...
    public ComparableParentId(Map<String, Object> input) {
        super(input);
    }
